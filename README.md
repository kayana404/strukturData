...
barisan pertama (for) untuk melakukan perulangan (for i in range(10): ) melakukan perulangan berjalan selama 10 kali perulangan,maka komplesitan waktunya adalah O(n)
barisan kedua 
